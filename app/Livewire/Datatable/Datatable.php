...
abstract class Datatable extends Component
{
    ...
    {
        $routes = [
            'create' => 'admin.'.$this->reout_prefix . Str::lower($this->getModelNamePlural()) . '.create',
            'view' => 'admin.' .$this->reout_prefix .  Str::lower($this->getModelNamePlural()) . '.show',
            'edit' => 'admin.' .$this->reout_prefix .  Str::lower($this->getModelNamePlural()) . '.edit',
            'delete' => 'admin.' . $this->reout_prefix . Str::lower($this->getModelNamePlural()) . '.destroy',
        ];
