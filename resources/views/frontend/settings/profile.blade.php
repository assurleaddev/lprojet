                ...
                <form @submit.prevent="submitForm" enctype="multipart/form-data"
                    ...
                    <div class="flex justify-end">
                        <button type="submit" :disabled="isLoading"
                            ...
                            <span x-show="isLoading" x-text="__('Updating...')"></span>
                            <span x-show="!isLoading">{{ __('Update profile') }}</span>
                        </button>
                    </div>

                    <!-- Cropper Modal -->
                    <div x-show="showCropper" style="display: none; background: rgba(0,0,0,0.6);"
                        class="fixed inset-0 z-[9998]" @click="closeCropper"></div>
                    <div x-show="showCropper" style="display: none;"
                        ...
                        <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 pointer-events-auto">
