        ...
        <div class="grid grid-cols-12 items-start gap-x-8">
            ...
            <div class="col-span-7">
                <div class="flex items-center gap-4">
                    ...
                    <!-- Stars + reviews (overall) -->
                    @if($stats['total'] > 0)
                        <div class="flex items-center gap-1">
                            @for ($i = 0; $i < 5; $i++)
                                <svg class="h-4 w-4 {{ $i < round($stats['avg']) ? 'text-amber-400' : 'text-gray-300' }}"
                        ...
                        <a href="#reviews" class="hover:underline text-[15px] text-gray-900">
                            {{ $stats['total'] }} avis
                        </a>
                    @endif
                </div>
...
@section('after_body')
    ...
    <script>
        // fav-badge clicks handled by the global handler in app.blade.php
