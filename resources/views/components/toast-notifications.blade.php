...
<div wire:ignore.self x-data="{
        ...
        variant: $event?.detail?.[0]?.variant || $event?.detail?.type || $event?.detail?.variant || 'info',
        title: $event?.detail?.[0]?.title || $event?.detail?.title || 'Notification',
        message: $event?.detail?.[0]?.message || $event?.detail?.message || '',
    })"
    ...
    x-on:mouseenter="$dispatch('pause-auto-dismiss')" x-on:mouseleave="$dispatch('resume-auto-dismiss')">
        ...
        <div>
            ...
            <template x-if="notification.variant === 'success'">
                <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                    ...
                    <div class="flex w-full items-center gap-3 bg-success-50 dark:bg-success-900/20 rounded-md p-4">
                        <!-- Icon -->
                        <div class="rounded-full bg-success-100 dark:bg-success-800/30 p-1.5 text-success-600 dark:text-success-400"
                            aria-hidden="true">
                        ...
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 x-cloak x-show="notification.title"
                                class="text-sm font-semibold text-success-800 dark:text-success-200"
                                x-text="notification.title"></h3>
                            <p x-cloak x-show="notification.message" class="text-sm text-gray-700 dark:text-gray-300"
            ...
            <template x-if="notification.variant === 'error' || notification.variant === 'danger'">
                <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                    ...
                    <div class="flex w-full items-center gap-3 bg-error-50 dark:bg-error-900/20 rounded-md p-4">
                        <!-- Icon -->
                        <div class="rounded-full bg-error-100 dark:bg-error-800/30 p-1.5 text-error-600 dark:text-error-400"
                            aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-5 h-5">
                                <path fill-rule="evenodd"
                        ...
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 x-cloak x-show="notification.title"
                                class="text-sm font-semibold text-error-800 dark:text-error-200"
                                x-text="notification.title"></h3>
                            <p x-cloak x-show="notification.message" class="text-sm text-gray-700 dark:text-gray-300"
                                x-text="notification.message"></p>
                        </div>
            ...
            <template x-if="notification.variant === 'warning'">
                <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                    ...
                    <div class="flex w-full items-center gap-3 bg-warning-50 dark:bg-warning-900/20 rounded-md p-4">
                        <!-- Icon -->
                        <div class="rounded-full bg-warning-100 dark:bg-warning-800/30 p-1.5 text-warning-600 dark:text-warning-400"
                            aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-5 h-5">
                                <path fill-rule="evenodd"
                        ...
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 x-cloak x-show="notification.title"
                                class="text-sm font-semibold text-warning-800 dark:text-warning-200"
                                x-text="notification.title"></h3>
                            <p x-cloak x-show="notification.message" class="text-sm text-gray-700 dark:text-gray-300"
                                x-text="notification.message"></p>
                        </div>
            ...
            <template x-if="notification.variant === 'info'">
                <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                    ...
                    x-transition:leave-start="translate-x-0 opacity-100">
                    <div
                        class="flex w-full items-center gap-3 bg-blue-light-50 dark:bg-blue-light-900/20 rounded-md p-4">
                        <!-- Icon -->
                        <div class="rounded-full bg-blue-light-100 dark:bg-blue-light-800/30 p-1.5 text-blue-light-600 dark:text-blue-light-400"
                            aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-5 h-5">
                                <path fill-rule="evenodd"
                        ...
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 x-cloak x-show="notification.title"
                                class="text-sm font-semibold text-blue-light-800 dark:text-blue-light-200"
                                x-text="notification.title"></h3>
                            <p x-cloak x-show="notification.message" class="text-sm text-gray-700 dark:text-gray-300"
                                x-text="notification.message"></p>
                        </div>
