...
<div x-data="itemListedModal(@js($initialProduct))"
    ...
    <div x-show="show"
        ...
        @click="show = false"
        class="fixed inset-0 z-[100] bg-gray-500/75 backdrop-blur-sm"
        x-cloak></div>

    <div x-show="show" class="fixed inset-0 z-[101] w-screen overflow-y-auto" x-cloak>
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div x-show="show" x-transition:enter="ease-out duration-300 transform"
                ...
                <div class="absolute inset-0 pointer-events-none overflow-hidden">
                    <!-- Top Left Confetti -->
                    <svg class="absolute top-10 left-10 w-12 h-12 text-blue-200 transform -rotate-12" fill="none"
                    ...
                    <!-- Bottom Right Swirl -->
                    <svg class="absolute bottom-10 right-10 w-16 h-16 text-teal-100" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 relative z-10">
                    <div class="text-center">
                        ...
                        <!-- Product Card -->
                        <div class="bg-white rounded-lg border border-gray-100 shadow-sm p-4 mb-6 max-w-xs mx-auto transform rotate-1"
                            x-show="product">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-sm font-medium text-gray-900 mb-1"
                                    x-text="product?.name.substring(0, 30) + (product?.name.length > 30 ? '...' : '')">
                                </p>
                                <div class="mt-4 bg-gray-50 p-3 rounded-lg flex items-center justify-between">
                                    <p class="text-sm font-medium text-gray-500">Price</p>
                                    <p class="text-base font-bold text-gray-900"><span
                                            x-text="product?.price_formatted"></span> MAD</p>
                                </div>
                            </div>
