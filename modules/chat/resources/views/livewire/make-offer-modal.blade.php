                ...
                <form wire:submit.prevent="submitOffer">
                    <div class="grid grid-cols-3 gap-3 mb-4">
                        <button type="button" @click="setDiscount(10)"
                            :class="offerType == 10 ? 'border-gray-900 text-gray-900 bg-gray-50' : 'border-gray-200 text-gray-700 hover:border-gray-300'"
                        ...
                        <button type="button" @click="setDiscount(20)"
                            :class="offerType == 20 ? 'border-gray-900 text-gray-900 bg-gray-50' : 'border-gray-200 text-gray-700 hover:border-gray-300'"
                            class="border rounded-md py-2 px-3 text-center transition-colors">
                        ...
                        <button type="button" @click="setCustom()"
                            :class="offerType == 'custom' ? 'border-gray-900 text-gray-900 bg-gray-50' : 'border-gray-200 text-gray-700 hover:border-gray-300'"
                            class="border rounded-md py-2 px-3 text-center transition-colors">
                    ...
                    <div class="mb-6">
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" step="0.01" min="0.01" max="{{ $product->price }}" wire:model="offerPrice"
                                class="block w-full rounded-md border-0 py-1.5 pl-12 pr-12 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-900 sm:text-sm sm:leading-6"
                                placeholder="0.00">
                        </div>
                    ...
                    <button type="submit" wire:loading.attr="disabled" wire:target="submitOffer"
                        class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white transition-colors disabled:opacity-50 bg-gray-900 hover:bg-gray-800">
